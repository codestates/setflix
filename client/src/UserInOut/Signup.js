...
export default function Signup() {
  ...
  const handleSignup = () => {
    ...
    axios.post("http://localhost:4000/setflix/users/signup", { userId, password, nickname, email }, { withCredentials: true }).then((res) => console.log(res));
  };
      ...
      <center>
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <div>
            ...
            {userInfo.password === passwordCheck.password ? <div> 비밀번호가 일치합니다 </div> : <div> 비밀번호가 일치하지 않습니다 </div>}
          </div>
          <div>
            <span>닉네임</span>
          ...
          <button className="btn email-check" type="submit">
            인증하기
          </button>
          <div>
            <span>이메일 인증</span>
